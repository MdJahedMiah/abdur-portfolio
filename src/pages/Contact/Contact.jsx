...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs.send(
      "service_fbpqrpa",   // Replace with your EmailJS Service ID
      "template_fsot4r4",  // Replace with your EmailJS Template ID
      formData,
      "7yks4L6ZTNm4hfxOQ"    // Replace with your EmailJS Public Key
    )
    .then((response) => {
